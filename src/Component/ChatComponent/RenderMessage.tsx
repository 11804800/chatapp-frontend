...
function ReplyMessage({ message }: any) {
    ...
    return (
        <div className=" text-zinc-600 rounded-md bg-black/10 flex overflow-hidden items-center h-fit" style={{ boxShadow: 'inset 2px 3px 4px rgba(0, 0, 0, 0.1)' }}>
