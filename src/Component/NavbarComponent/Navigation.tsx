...
function Navigation() {
    ...
    return (
        <div className={`${RecipentName ? "hidden lg:flex" : "flex"} bg-white w-full border-t md:w-fit md:border-r-[1px] border-zinc-200  flex-row md:flex-col justify-between h-fit md:h-full px-2`}>
